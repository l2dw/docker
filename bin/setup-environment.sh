...
# Docker registry
DOCKER_REGISTRY_HOST=${DOCKER_REGISTRY_HOST:-${DOCKER_REGISTRY:-}}
DOCKER_REGISTRY_USER=${DOCKER_REGISTRY_USER:-${DOCKER_USER:-docker}}
DOCKER_REGISTRY_PASS=${DOCKER_REGISTRY_PASS:-${DOCKER_PASSWORD:-docker}}
